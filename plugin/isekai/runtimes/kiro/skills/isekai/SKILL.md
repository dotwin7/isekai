...
Use the ISEKAI Core through the repository-local interface. This plugin is a thin Kiro adapter; it is not an independent agent brain and has no Ouroboros dependency.
